...
_Regenerated 2026-09-07 05:12 IST from `status/*.status` — do not hand-edit this file; edit your feature's own status file and re-run `bash status/render.sh`._
...
| F03 | Module-brief atomizer | orb | contract | lead-architect (dispatched) | 2026-09-07 05:12 IST |  |
...
| F06 | lld-ready gate (depth-bar enforcement) | fleet | contract | lead-architect (dispatched) | 2026-09-07 05:12 IST |  |
