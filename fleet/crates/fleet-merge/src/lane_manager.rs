...
use fleet_types::{Blueprint, Module};
...
impl LaneManagerError {
    ...
    pub fn exit_code(&self) -> fleet_types::ExitCode {
        match self {
            LaneManagerError::WorktreeCreationFailed(_) => fleet_types::ExitCode::Env,
            LaneManagerError::MergeFailed(_) => fleet_types::ExitCode::Invariant,
            LaneManagerError::WorktreeRemovalFailed(_) => fleet_types::ExitCode::Env,
            LaneManagerError::ModuleNotFound(_) => fleet_types::ExitCode::Invariant,
        }
    }
}
...
mod tests {
    ...
    fn test_lane_manager_error_exit_code() {
        ...
        assert_eq!(error.exit_code(), fleet_types::ExitCode::Invariant);
    }
}
