...
use super::module_brief_core::{as_str, is_non_empty_str, is_string_array};
use super::registry_verdict::check_registry_verdict;
use super::violation::v;
use super::violation::Violation;
use serde_json::{Map, Value};

#[path = "module_brief_acceptance.rs"]
mod module_brief_acceptance;
use module_brief_acceptance::check_acceptance;

pub(crate) fn check_module_brief_mid(
    b: &Map<String, Value>,
    node_id: Option<&str>,
