...
//! `stamped_by` live in `freeze_rest.rs` to stay under the 80-line cap.

use super::freeze_rest::check_freeze_rest;
use super::module_brief_core::{
    as_str, is_non_empty_str, valid_content_hash, valid_freeze_id, valid_node_id,
};
