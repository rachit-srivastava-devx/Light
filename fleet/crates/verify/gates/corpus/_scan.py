...
PRUNED_DIRS = {
    ...
    ".venv",
    "__pycache__",
    # This detector corpus itself: it lives at gates/corpus (moved from tests/corpus) and its
    # scripts embed literal copies of the bad-code patterns they detect, as fixtures for
    # _selftest.sh. Left unpruned, a detector would trip on its own fixture text forever --
    # planted and removed alike -- because the corpus tree is part of every scanned ROOT.
    "corpus",
    "docs",
    "node_modules",
    "site-packages",
