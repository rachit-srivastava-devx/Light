use super::super::super::sandbox::agent_registry::AgentFacts;
use super::super::super::sandbox::templates::SKILLS_TOML as EMBEDDED_SKILLS_TOML;
use super::*;
use std::fs;
...
fn unresolved_skill_is_caught() {
    ...
    assert_eq!(
        err,
        ProvisionError::UnresolvedSkill("debugging".to_string())
    );
}
