...
pub fn dispatch(runtime: &route::RuntimeState, task_id: &types::TaskId) -> Result<(), PipelineError> {
    let decision = route::decide(Some(Role::Builder), route::TaskClass::General, None, runtime);
